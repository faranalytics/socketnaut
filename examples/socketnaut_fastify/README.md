...
In this example you will use Socketnaut to scale the main module of a Fastify server.  The `ServiceProxy` is configured to start up 4 `http_server.js` Workers and scale up to 42 Workers on demand.
